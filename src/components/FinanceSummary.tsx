...
const data = [
  { name: "RECEITA", value: 3500, color: "hsl(157, 76%, 36%)" },
    ...
    <div className="bg-card rounded-2xl p-5 shadow-card game-card-hover">
      ...
      <div className="flex items-end gap-6">
        ...
        <div className="flex flex-col items-end gap-1 min-w-fit">
          <span className="text-game-green font-bold text-lg font-display">R$ 3.500</span>
          <span className="text-destructive font-bold text-lg font-display">R$ 2.100</span>
        </div>
      </div>
      ...
      <div className="flex gap-3 mt-3">
        <button className="flex-1 bg-game-green text-primary-foreground font-display font-bold text-xs py-2.5 rounded-xl flex items-center justify-center gap-1 shadow-button hover:brightness-110 transition-all">
